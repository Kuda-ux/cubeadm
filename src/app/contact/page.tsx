...
export const metadata: Metadata = {
  ...
  description: 'Contact CubeADM for IT training enrollment, IT solutions quotes, and consultations. Located in Harare, Zimbabwe. Call +263 77 123 4567 or email info@cubeadm.co.zw. Serving Zimbabwe and Southern Africa.',
